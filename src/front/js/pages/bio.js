...
export const Bio = () => {
  ...
  return (
    <div className="div-bio container ">
      ...
      <div className="lines-images-boxes row justify-content-center d-flex  m-auto">
        ...
        {/* <div className="div-img col p-0">
            <i className="fa-solid fa-comment " id="bubble-1" />
            <p id="text-1" className="position-absolute text-white text-center">
              Texto de ejemplo
            </p>
          </div> */}
        {/* <img
            ...
            alt=""
            id="bubble-1"
            className="position-absolute col-2 col-sm-4 col-lg-2"
          /> </div>*/}
        {/* </div> */}
